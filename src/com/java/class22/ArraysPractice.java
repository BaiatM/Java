...
public class ArraysPractice {
    public static void main(String[] args) {
        ...
        int data1[] = new int[5]; // declaration and initialization in one line

        int numbers[] = {10,20,30,40,50,60,70,80,90,123,321}; //declaration and assignment in the smae line

        System.out.println(numbers[5]); // printing value at particular index
